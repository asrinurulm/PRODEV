...
<div class="col-md-12 col-sm-12 col-xs-12 content-panel">
  <div class="x_panel">
    <div class="x_title">
      <h3><li class="fa fa-book"> Nama Formula</li></h3>
    </div>
										...
										<div class="panel-body badan">
											...
											<table class="col-md-5 col-sm- col-xs-12">
												...
												<tr>
													...
													<th width="45%">: {{ $formula->versi }}.{{ $formula->turunan }}</th>
												</tr>
												<tr>
										...
										<table class="table table-bordered">
											<thead>
												<tr style="font-weight: bold;color:white;background-color: #2a3f54;">
													...
													<th class="text-center">No.HUS</th>
											...
											<tbody>
												@foreach($panel as $p)
												<tr>
													<td class="text-center">{{$p->panel}}</td>
													<td class="text-center">{{$p->tgl_panel}}</td>
													<td class="text-center">{{$p->hus}}</td>
													<td>{{$p->kesimpulan}}</td>
												</tr>
												@endforeach
											</tbody>
										...
										<table class="table table-bordered">
											<thead>
												<tr style="font-weight: bold;color:white;background-color: #2a3f54;">
													...
													<th class="text-center">Suhu Panel</th>
											...
											<tbody>
												...
												<tr>
													<td class="text-center">{{$st->no_PST}}</td>
													<td class="text-center">{{$st->suhu}}</td>
													<td class="text-center">{{$st->estimasi_selesai}}</td>
													<td class="text-center">{{$st->no_HSA}}</td>
													<td>{{$st->keterangan}}</td>
													<td>
														<table>
															<tr>
																<td><a href="{{asset('data_file/'.$st->data_file)}}" download="{{$st->data_file}}" title="download file"><button class="btn btn-primary btn-sm"><li class="fa fa-download"></li></button></a></td>
																<td> {{ $st->data_file }}</td>
															</tr>
														</table>
													</td>
								...
								<div class="panel">
									<table class="Table table-bordered">
										...
										<tbody>
											@foreach($fs as $fs)
											<tr>
												<td class="text-center">{{$fs->kemungkinan}}</td>
												<td class="text-center"><span class="labell label-success " style="color:#ffff">{{ $fs->status_kemas }}</span></td>
												<td class="text-center"><span class="labell label-success " style="color:#ffff">{{ $fs->status_mesin }}</span></td>
												<td class="text-center"><span class="labell label-success " style="color:#ffff">{{ $fs->status_sdm }}</span></td>
												<td class="text-center"><span class="labell label-success " style="color:#ffff">{{ $fs->status_lab }}</span></td>
												<td class="text-center"><a href="{{ route('summary',['id_feasibility' => $fs->id_feasibility, 'id_formula' => $fs->id_formula]) }}" type="submit" class="btn btn-info fa fa-eye" data-toggle="tooltip" data-placement="top" title="lihat"></a></td>
											</tr>
											@endforeach
										</tbody>
									</table>
